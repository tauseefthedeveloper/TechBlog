...
<div class="col-md-6 mb-2 border-rounded">
    <div class="card">
        ...
        <div class="card-footer text-center">
            ...
            if (user == null) {
            %>
                <a href="#!" onclick="loginThenLike()" class="btn btn-outline-primary btn-sm">
                    <i class="fa fa-thumbs-o-up"></i>
                    <span class="like-count"><%=likeDao.countLikesOnPosts(p.getPid())%></span>
                </a>
                <a href="#!" onclick="loginThenRead()" class="btn btn-outline-primary btn-sm">Read More...</a>
                <a href="#!" onclick="loginThenComment()" class="btn btn-outline-primary btn-sm">
                    <i class="fa fa-commenting-o"></i>
                    <span><%=likeDao.countCommentOnPosts(p.getPid())%></span>
                </a>
            <%
            } else {
            %>
            ...
            %>
                    ...
                    <a href="#!" id="delete-btn" style="font-size:20px;"
